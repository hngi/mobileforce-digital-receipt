            ...
            children: <Widget>[
              Expanded(
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          child: Text(
                            "Date:" + Provider.of<Receipt>(context,listen: false).issuedDate.toString(),
                            style: TextStyle(
                              color: Colors.black,
                              fontSize: 13,
                              letterSpacing: 0.03,
                        ...
                        Text(
                            Provider.of<Receipt>(context,listen: false).receiptNo.toString() == null ? 'receipt No :' + "AutoGenerated" :'receipt No :' + Provider.of<Receipt>(context,listen: false).receiptNo.toString(),
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: 13,
                              letterSpacing: 0.03,
                        ...
                        Container(
                          padding: EdgeInsets.only(bottom: 8),
                          child: Text(
                            'Name:'+ Provider.of<Receipt>(context,listen: false).customer.name.toString(),
                            style: TextStyle(
                                color: Colors.black,
                                fontSize: 14,
                                letterSpacing: 0.03,
                        ...
                        Container(
                          padding: EdgeInsets.only(bottom: 8),
                          child: Text(
                            'Email' + Provider.of<Receipt>(context,listen: false).customer.email.toString(),
                            style: TextStyle(
                                color: Colors.black,
                                fontSize: 14,
                                letterSpacing: 0.03,
                        ...
                        Text(
                          'Phone No:' + Provider.of<Receipt>(context,listen: false).customer.phoneNumber.toString(),
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: 14,
                              letterSpacing: 0.03,
                  ...
                  Divider(),
                  Container(height: 200,child: ReceiptItem()),
                  SizedBox(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            Provider.of<Receipt>(context,listen: false).paidStamp != false ? Image.asset('assets/images/paid-stamp.png'): Container(),
                            Padding(
                              padding: const EdgeInsets.only(top: 15.0),
                              child: Text(
                                  '₦',
