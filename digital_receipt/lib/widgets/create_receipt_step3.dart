...
class CreateReceiptStep3 extends StatefulWidget {
  CreateReceiptStep3({
  ...
  @override
  _CreateReceiptStep3State createState() => _CreateReceiptStep3State();
}

class _CreateReceiptStep3State extends State<CreateReceiptStep3> {
