...
class ProductDisplay extends StatefulWidget {
  ...
  const ProductDisplay({Key key, this.items, this.updateFn, this.showBottomSheet}) : super(key: key);
  @override
    ...
    return items.isEmpty ? Text('empty') : ListView.builder(
      ...
      itemBuilder: (context, index){
        return Dismissible(
          ...
          background: Container(color: Colors.grey[300],child: Align(alignment: Alignment.center,child: Text('Delete Product', style: TextStyle(fontSize: 15),)),),
          ...
          child: Column(
            children: <Widget>[
              CardTile(
                ...
                amount: 'N' + items[index].amount.toString(),
